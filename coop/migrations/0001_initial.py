# Generated by Django 5.0.6 on 2024-07-13 16:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan_application', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='status', to='coop.loanapplication')),
            ],
        ),
        migrations.CreateModel(
            name='Membership',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('otp_code', models.CharField(default='a5f338', max_length=6)),
